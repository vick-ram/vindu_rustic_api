...
object InventoryReservationMapper : RowMapper<Row, InventoryReservation> {
    ...
    override fun toRow(model: InventoryReservation): Map<String, Any?> {
        return Properties.encodeToMap(model)
    }

    override fun getId(model: InventoryReservation): Any = model.id
